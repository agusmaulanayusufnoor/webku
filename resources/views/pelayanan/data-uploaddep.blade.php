        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             ...
             <a class="btn btn-outline-secondary" href="{{ url('pelayanan/uploaddep') }}" role="button">
...
<!-- tabel yg dipakai -->
              <div class="card">
                <div class="card-header bg-secondary">
                  <h3 class="card-title">Downlod File Deposito</h3>
                </div>
              <!-- /.card-header -->
                ...
                <tfoot style="display:table-header-group;">
                  ...
                  <tr>
                     ...
                     <td>
                      ...
                      <td>
                        <div class="row justify-content-md-center">
                            <a href="{{ asset('filedep/'.$value -> file) }}">
                      ...
                      <td>
                      <div class="row justify-content-md-center">
                      <form method="post" action="{{ url('pelayanan/downloaddep/'.$value->id) }}">
                            @csrf
