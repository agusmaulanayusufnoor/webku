...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0">UPLOAD FILE TABUNGAN</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                 <a class="btn btn-outline-secondary" href="{{ url('pelayanan/downloadtab') }}" role="button">
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body mx-auto" style="width: 60%;">
      ...
      @if(count($errors) > 0)
				...
				@endif
      <form action="{{ url('/pelayanan/simpantab-file') }}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group input-group">
            <div class="input-group-prepend">
                ...
                type="text" onkeypress="return /['0-9']/i.test(event.key)" maxlength="12" oninput="this.value = this.value.toUpperCase()">
                @error('no_rekening')
