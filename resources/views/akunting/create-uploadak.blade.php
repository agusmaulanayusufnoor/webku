...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="m-0">UPLOAD FILE AKUNTING</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                 <a class="btn btn-outline-info" href="{{ url('akunting/download') }}" role="button">
  ...
  <div class="card card-primary">
    ...
    <div class="card-body mx-auto" style="width: 60%;">
      ...
      @if(count($errors) > 0)
				...
				@endif
      <form action="{{ url('/akunting/simpan-file') }}" method="post" enctype="multipart/form-data">
          @csrf
